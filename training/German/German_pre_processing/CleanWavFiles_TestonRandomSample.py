...
folder = 'wavs'
path_to_waves = os.path.join(root_german,folder)
# print(path_to_waves )
...
file_name = 'German_TTS_020181.wav'
...
# root = 'd:\cleaningWaveFiles'

# # write original wave
# original_file_name = 'original_'+file_name
# original_path = os.path.join(root,original_file_name)
# sf.write(original_path, wav, sr)

# # write timed
# trimed_file_name = 'trimed_'+file_name
# trimed_path = os.path.join(root,trimed_file_name)
# sf.write(trimed_path, trimed, sr)

# # write split
# split_file_name = 'split_'+file_name
# original_path = os.path.join(root,split_file_name)
# sf.write(original_path, split, sr)
